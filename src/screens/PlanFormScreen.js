...
class PlanFormScreen extends Component {
  ...
  toggleDateTimePicker = () => {
    this.setState(
      state => (this.state.dateTimePickerVisible = !state.dateTimePickerVisible)
    );
  };
